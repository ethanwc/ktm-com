...
public class OpenSourceLicensesSettingsFragment
  extends NavAppBaseFragment
{
  ...
  public OpenSourceLicensesSettingsFragment() {}
  
  private void initialize(boolean paramBoolean)
  {
    mWebView.setWebViewClient(new OpenSourceLicensesSettingsFragment.1(this));
    mWebView.loadUrl("file:///android_asset/android_open_source_licenses_en.html");
  ...
  public void closeOpenSourceLicensesSettings()
  {
  ...
  {
    boolean bool2 = false;
    paramLayoutInflater = paramLayoutInflater.inflate(2131427416, paramViewGroup, false);
