  ...
  implements Unbinder
{
  ...
  public RoutePreviewFragment_ViewBinding(RoutePreviewFragment paramRoutePreviewFragment, View paramView)
  {
    ...
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.1(this, paramRoutePreviewFragment));
    localView.setOnLongClickListener(new RoutePreviewFragment_ViewBinding.2(this, paramRoutePreviewFragment));
    ...
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.3(this, paramRoutePreviewFragment));
    mChartView = ((com.com.navapp.ui.widgets.ChartView)Utils.findRequiredViewAsType(paramView, 2131230821, "field 'mChartView'", com.ktm.navapp.ui.widgets.ChartView.class));
    ...
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.4(this, paramRoutePreviewFragment));
    localView = Utils.findRequiredView(paramView, 2131231154, "method 'onRouteOptions'");
    view7f0801b2 = localView;
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.5(this, paramRoutePreviewFragment));
    localView = Utils.findRequiredView(paramView, 2131231149, "method 'closeRoutePreview'");
    view7f0801ad = localView;
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.6(this, paramRoutePreviewFragment));
    localView = Utils.findRequiredView(paramView, 2131230899, "method 'closeRoutePreview'");
    view7f0800b3 = localView;
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.7(this, paramRoutePreviewFragment));
    localView = Utils.findRequiredView(paramView, 2131231173, "method 'onRemoteRouteCancel'");
    view7f0801c5 = localView;
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.8(this, paramRoutePreviewFragment));
    localView = Utils.findRequiredView(paramView, 2131231174, "method 'onRemoteRouteYes'");
    view7f0801c6 = localView;
    localView.setOnClickListener(new RoutePreviewFragment_ViewBinding.9(this, paramRoutePreviewFragment));
    paramView = Utils.findRequiredView(paramView, 2131231336, "method 'onWarningOkClicked'");
    view7f080268 = paramView;
    paramView.setOnClickListener(new RoutePreviewFragment_ViewBinding.10(this, paramRoutePreviewFragment));
  }
