...
{
  static final String CLASS_TAG = com.ktm.navapp.offroad.OffroadGuidance.class.getSimpleName();
  private static final String[] COMPASS_POINTS_225;
  private static final String[] COMPASS_POINTS_45 = { "N", "NE", "E", "SE", "S", "SW", "W", "NW", "N" };
  ...
  public static double headDeltaSigned(double paramDouble1, double paramDouble2)
  {
    ...
    paramDouble1 = (d - paramDouble1 + 900.0D) % 360.0D - 180.0D;
    if (Math.abs(paramDouble2) < Math.abs(paramDouble1)) {
      return paramDouble2;
    }
    return paramDouble1;
  }
  ...
  public static void setDestination(Waypoint paramWaypoint)
  {
    if (paramWaypoint != null) {
      paramWaypoint = HereObjectsFactory.getGeoCoordinate(latitude, longitude);
    } else {
      paramWaypoint = null;
    }
